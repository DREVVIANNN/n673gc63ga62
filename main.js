...
const linkAction = () =>{
    const navMenu = document.getElementById('nav-menu')
    // ketika aku click di antara nav__link, aku menghapus show-menu
    navMenu.classList.remove('show-menu')
}
...
const blurHeader = () =>{
    ...
    // menambahkan class jika bawahan offset melebihi 50
...
gsap.from('.home__lantern1', 1.5, {opacity: 0, x: 70, delay: 3, ease: 'back.out(1.5'})
gsap.from('.home__lantern2', 1.5, {opacity: 0, x: -70, delay: 3.5, ease: 'back.out(1.5'})
